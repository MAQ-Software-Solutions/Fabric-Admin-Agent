# 05 — Connections (OAuth2 / SPN / Workspace Identity)
...
### 15.1 Configure the PBI Service Web v2 Connection
...
### 15.2 Configure the PBI Semantic Model Connection
...
### 15.3 Configure the Azure Data Explorer (Kusto) Connection
...
### 15.4 Configure the SQL Server Connection
...
**Next:** [Azure Open AI Setup →](./06-azure-openai-api-key.md)